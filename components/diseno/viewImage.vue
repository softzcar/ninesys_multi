<template>
  <div>
    <b-button variant="primary" @click="$bvModal.show(modalView)">
      <b-icon icon="file-image"></b-icon>
    </b-button>

    <b-modal :size="size" :title="title" :id="modalView" hide-footer>
      ...
      > -->
      Enviar aprobación <span v-html="whatsAppMe('584147307169', true, msgAprobacion)">Enviar aprobación</span>
      <p style="color: #fff" id="parrafoParaCopiar">{{ url }}</p>
