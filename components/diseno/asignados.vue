        ...
        <b-col>
          <b-table responsive :fields="fields" :items="items">
            ...
            <template #cell(revision)="data">
              <diseno-uploadImageRevision :revisiones="revisiones" :item="data.item" :@reload="reloadDisenos" />
            </template>
            ...
            <template #cell(tallas_y_personalizacion)="data">
              <diseno-tallasPersoalizacion :revisiones="revisiones" :item="data.item" :@reload="reloadDisenos" />
            </template>
          </b-table>
        </b-col>
      </b-row>
