                  ...
                  <strong>Clientes</strong>
                    ...
                    <b-row>
                        <b-col>
                            ...
                            <b-row>
                                <b-col>
                                    <b-button @click="guardarPresupuesto" class="floatme"
                                        variant="success">Guardar</b-button>
                                    <b-button @click="cargarPresupuesto" class="floatme"
                                        variant="info">Cargar</b-button>
                                                        ...
                                                        <b-row>
                                                            <b-col lg="12" class="mt-4">
                                                                <b-table :stacked="isSmallScreen
                                                                    ? 'md'
                                                                    : false" :responsive="!isSmallScreen"
                                                                    borderless striped :primary-key="form
                                                                        .productos
                                                                        .item
                                                                        " :fields="campos
                                  ...
                                  <b-row align-h="start">
                                    <b-col>
                                      ...
                                      <hr />
                                                ...
                                                <b-tab title="Emitir Presupuesto" title-link-class="h5"
                                                    :disabled="disable3">
                                                    <div class="wizard-content">
                                                        <b-row>
                                                            <b-col>
                                                            ...
                                                            <b-col>
                                                                <div id="reporte">
                                                                    <b-overlay :show="overlay
                                                                        ">
                                                                        <ordenes-presupuestoPreview :form="form
                                                                            " :showpreview="true
                                                                                " />
                                                                    </b-overlay>
                                                                </div>
    ...
    methods: {
        ...
        guardarPresupuesto() {
            if (this.form.id === "") {
                ...
                this.$confirm("", `¿Desea guardar el presupuesto?`, "question")
                    .then(() => {
 ...
 */
        ...
        async finishOrder() {
            ...
            data.set(
                ...
                JSON.stringify(
                    this.form.productos.filter((prod) =>
            ...
            await this.$axios
                ...
                .then((data) => {
                    console.log(
                        `El presupuesto ${data.orden_nro} ha sido creado`
                    )
                    console.dir(data)
        ...
        async loadDataComercializacion() {
            await this.$axios
                .all([
                    ...
                    this.$axios.get(`${this.$config.API}/categories`),
                    this.$axios.get(`${this.$config.API}/telas`),
                    this.$axios.get(`${this.$config.API}/sizes`),
                    //   this.$axios.get(`${this.$config.API}/ordenes/guardadas`),
                    this.$axios.get(`${this.$config.API}/ordenes/guardadas`),
                ])
                .then(
                    this.$axios.spread(
