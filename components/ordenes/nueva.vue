                              ...
                              <b-row>
                                <b-col lg="12">
                                  <b-form v-on:submit.prevent>
                                    <b-form-group>
                                      <label for="input-fecha">Fecha de entega
                          ...
                          <div class="wizard-content">
                            ...
                            <b-row>
                              ...
                              <b-col lg="12">
                                ...
                                <quill-editor v-model="form.obs" :options="quillOptions"
        ...
        .finally(() => {
          axios
            ...
            .then((responseClientes) => {
              ...
              if (!this.form.id) {
                const currCustomer = responseClientes.data.data.find(el => el.cedula === this.form.cedula)
