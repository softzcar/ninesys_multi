                              ...
                              <b-row>
                                <b-col lg="12">
                                  <b-form v-on:submit.prevent>
                                    ...
                                    <SelectorGeografico v-model="form.geografia" :disabled="form.guardarStock" class="mt-3" />
                                  </b-form>
                                  <p info-form>
                                    <span required>*</span>
                                    Campos obligatorios
...
export default {
  ...
  methods: {
    ...
    async onPhoneBlur() {
      ...
      // Autocompletar si ya existe un cliente con ese teléfono (por últimos 10 dígitos).
      // Se setea form.id para REUTILIZAR ese cliente al guardar la orden.
      try {
