    ...
    <b-row>
      <b-col>
            ...
            <th>
              <table class="table-header">
                <tr>
                  <td>
                    <h1>PRESUPUESTO</h1>
                    <h2>{{ this.$config.EMPRESA.nombre }}</h2>
                    <p>{{ this.$config.EMPRESA.direccion }}</p>
                    <p>{{ this.$config.EMPRESA.email }}</p>
                    <p>{{ this.$config.EMPRESA.telefono }}</p>
                  </td>
                </tr>
                <tr>
                  <td>
        ...
        <div style="text-align: right">
          ...
          <h1 style="margin-top: 40px">TOTAL: {{ floatMe(montoTotalOrden(form.productos)) }}</h1>
        </div>
