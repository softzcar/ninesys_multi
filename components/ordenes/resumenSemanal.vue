      ...
      <b-row>
        <b-col>
          <b-list-group class="mb-4 mt-2">
            <b-list-group-item>
              <strong>Abonado:</strong> $ {{ totalAbonado }}</b-list-group-item
            >
            <b-list-group-item>
              <strong>Crédito:</strong> $ {{ totalCredito }}</b-list-group-item
            >
            <b-list-group-item>
        ...
        <b-col>
          ...
          >
            ...
            <template #cell(acc)="data">
              ...
              <div style="float: left; margin-right: 6px">
                <ordenes-editar :key="data.item.orden" :data="data.item" />
              </div>
              <div style="float: left; margin-right: 6px">
                <ordenes-abono
                  :key="data.item.orden"
