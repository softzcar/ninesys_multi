            ...
            PROPS: {{ $props }}
                    ...
                    <b-list-group>
                        <b-list-group-item
                            ...
                            {{ datos.name }}</b-list-group-item
                        >
                        <b-list-group-item
                            ><strong>Tela:</strong>
                            {{ datos.tela }}</b-list-group-item
                        >
                        <b-list-group-item
                            ><strong>Talla:</strong>
                            {{ datos.talla }}</b-list-group-item
                        >
                        <b-list-group-item
                            ><strong>Corte:</strong>
                            {{ datos.corte }}</b-list-group-item
                        >
                        <b-list-group-item
                ...
                ></b-form-input> -->
                        ...
                        <template #cell(_id)="data">
                            <b-button
                                variant="danger"
                                @click="filterData(data.item._id)"
                            >
...
export default {
    ...
    methods: {
        ...
        async getMovimientos() {
            await this.$axios
                .get(
                    `${this.$config.API}/inventario/historial/${this.datos.id_orden}`
                )
                .then((resp) => {
        ...
        async filterData(id_insumo) {
            ...
            await this.$axios
                .post(
                    `${this.$config.API}/inventario-movimientos/eliminar`,
                    data
                )
                .then((res) => {
                    this.overlay = false
