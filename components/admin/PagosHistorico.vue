<template>
    <div>
        <b-row>
            <b-col>
                <b-calendar block v-model="value" @selected="getPagosHistorico" @context="onContext"
                    locale="es-VE"></b-calendar>
            </b-col>
            <b-col>
                ...
                <b-col class="mt-4">
                    ...
                    <b-table responsive small striped :items="pagosResumenVendedores" :fields="fields">
                        <template #cell(nombre)="data">
                            <admin-PagosVendedorResumen showbutton="false" :item="data.item" @reload="reloadMe"
            ...
            <b-row>
                <b-col class="mt-4">
                    ...
                    <b-table responsive small striped :items="pagosResumen" :fields="fields">
                        <template #cell(nombre)="data">
                            <admin-PagosEmpleadoResumen showbutton="false" :item="data.item" :products="products"
                                @reload="reloadMe" :detalles="filterEmpleado(data.item.id_empleado)" />
                        </template>
            ...
            <b-row>
                <b-col class="mt-4">
                    ...
                    <b-table responsive small striped :items="pagosResumenDiseno" :fields="fields">
                        <template #cell(nombre)="data">
                            <admin-PagosDisenioResumen showbutton="false" :item="data.item" @reload="reloadMe"
...
export default {
    ...
    methods: {
        ...
        async getPagosHistorico() {
            // this.overlay = true
            await this.$axios
                .get(`${this.$config.API}/pagos/historico/${this.obtenerNumeroSemana(this.value)}`)
                .then((res) => {
        ...
        obtenerNumeroSemana(fechaStr) {
            ...
            const numeroSemana = Math.ceil((diferenciaDias + inicioAño.getDay() + 1) / 7);
