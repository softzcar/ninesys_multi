<template>
    <div>
        <b-button @click="$bvModal.show(modal)">Inicio Orden</b-button>

        <b-modal :id="modal" :title="title" hide-footer size="lg">
            <b-overlay :show="overlay" spinner-small>
                <div class="text-center mb-4 mt-2">
                    <b-button
                        @click="sendMsgCustom(idorden, 'inicio')"
                        variant="success"
                ...
                <b-form>
                    <b-form-group
                        id="group-1"
                        label="Mensaje de incio de Orden"
...
export default {
    ...
    mounted() {
        this.mensaje =
            this.$store.state.login.dataEmpresa.config_empresa.msg_welcome;
    },
