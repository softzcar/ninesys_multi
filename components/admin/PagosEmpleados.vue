...
export default {
  ...
  methods: {
    ...
    async getPagosDisenadores() {
      ...
      await axios
        ...
        .then((res) => {
          ...
          this.pagosTrabajosAdicionales = res.data.data.trabajos_adicionales
          // this.overlay = false
        })
    },
    ...
    async getFilteredData() {
      ...
      await axios.post(`${this.$config.API}/pagos/semana`, data).then((res) => {
        this.overlay = false
        this.pagos = []
        this.pagos = res.data
        this.pagosVendedores = res.data.data.vendedores
        this.pagosEmpleados = res.data.data.empleados
        this.pagosDiseno = res.data.data.this.pagosTrabajosAdicionales =
