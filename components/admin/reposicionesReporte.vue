<template>
  <div>
    ...
    <!-- Modal Detalle de la Reposición (solo lectura, sin acciones) -- componente
         compartido, reusado también en la Planilla de Pagos para ver el detalle
         de una reposición desde su número (ver PagosReporteEmpleado.vue). -->
...
export default {
  ...
  methods: {
    ...
    verDetalleReposicion(item) {
      this.$refs.detalleReposicionModal.abrirConItem(item);
    },
