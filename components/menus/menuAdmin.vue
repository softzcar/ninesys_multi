                  ...
                  <span @click="navigate" @keypress.enter="navigate" role="link">
                    Ordenes con deuda
                            ...
                            <b-nav-item-dropdown text="Caja" right>
                                ...
                                <router-link
                                    class="nav-link"
                                    to="/comercializacion/cierre-de-caja"
                                    custom
                                    v-slot="{ navigate }"
                                >
                                    <span
                                ...
                                <router-link
                                    class="nav-link"
                                    to="/comercializacion/reporte-de-caja"
                                    custom
                                    v-slot="{ navigate }"
                                >
                                    <span
                                ...
                                <router-link
                                    class="nav-link"
                                    to="/comercializacion/reportes/pagos-abonos"
                                    custom
                                    v-slot="{ navigate }"
                                >
                                    <span
