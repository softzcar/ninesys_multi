          ...
          <b-collapse id="nav-collapse" is-nav>
            <b-navbar-nav>
              ...
              <b-nav-item-dropdown text="Ordenes y Lotes" right>
                ...
                <router-link class="nav-link" to="/comercializacion/presupuesto" custom v-slot="{ navigate }">
                  <span @click="navigate" @keypress.enter="navigate" role="link">
                    Nuevo Presupuesto
                  </span>
                </router-link>
                ...
                <router-link class="nav-link" to="/produccion/ordenes-todas" custom v-slot="{ navigate }">
                  <span @click="navigate" @keypress.enter="navigate" role="link">
                    Todas las ordenes
                  </span>
                ...
                <router-link class="nav-link" to="/comercializacion/ordenes/semana" custom v-slot="{ navigate }">
                  <span @click="navigate" @keypress.enter="navigate" role="link">
              ...
              <b-nav-item-dropdown text="Caja" right>
                ...
                <router-link class="nav-link" to="/comercializacion/abonos" custom v-slot="{ navigate }">
                  <span @click="navigate" @keypress.enter="navigate" role="link">
                    Otros Abonos
                  </span>
                </router-link>

                <router-link class="nav-link" to="/comercializacion/cierre-de-caja" custom v-slot="{ navigate }">
                  <span @click="navigate" @keypress.enter="navigate" role="link">
                    Cierre de Caja
                  </span>
                </router-link>

                <router-link class="nav-link" to="/comercializacion/reporte-de-caja" custom v-slot="{ navigate }">
                  <span @click="navigate" @keypress.enter="navigate" role="link">
                    Reporte de Caja
                  </span>
                </router-link>
              ...
              <b-nav-item-dropdown text="Inventario" right>
                ...
                <router-link class="nav-link" to="/inventario/reportes/semana" custom v-slot="{ navigate }">
                  <span @click="navigate" @keypress.enter="navigate" role="link">
                    Reporte por semana
                  </span>
                </router-link>
              ...
              <b-nav-item-dropdown text="Empleados" right>
                ...
                <router-link class="nav-link" to="/asistencias/reporte-semanal" custom v-slot="{ navigate }">
                  <span @click="navigate" @keypress.enter="navigate" role="link">
              ...
              <b-nav-item-dropdown text="Varios" right>
                ...
                <router-link class="nav-link" to="/produccion/reporte-reposiciones" custom v-slot="{ navigate }">
                  <span @click="navigate" @keypress.enter="navigate" role="link">
              ...
              <router-link class="nav-link" to="/empleados/planilla-de-pagos" custom v-slot="{ navigate }">
                <span @click="navigate" @keypress.enter="navigate" role="link">
                  Planilla De Pagos
                </span>
              </router-link>
