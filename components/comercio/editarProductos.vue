            ...
            <div v-else>
                <b-alert show variant="warning">
                    ...
                    <p class="mb-0">
                        ...
                        y
                        <strong
                            >vinculela la Orden número {{ item.orden }}.</strong
                        >
                    </p>
                </b-alert>
            </div>
...
export default {
    ...
    methods: {
        ...
        async verificarEdicion() {
            ...
            await this.$axios
                .get(
                    `${this.$config.API}/ordenes/verificar-edición/${this.item.orden}`
                )
                .then((resp) => {
        ...
        async getProductsOrder() {
            await this.$axios
                .get(
                    `${this.$config.API}/productos-asignados/${this.item.orden}`
                )
                .then((resp) => {
