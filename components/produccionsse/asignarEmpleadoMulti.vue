    ...
    <div>
        <b-form inline class="mb-4 mt-4">
            ...
            <b-form-group id="button-group-1">
                <b-button class="mr-2" @click="asignarEmpleado" variant="light">
            ...
            <b-form-group id="button-group-1">
                ...
                <span class="porcentaje"
                    >Total porcentaje {{ calculoPorcentaje }}%</span
                >
            </b-form-group>
        </b-form>
...
export default {
    ...
    computed: {
        ...
        sonComisionesIguales() {
            ...
            return this.form.every(
                (objeto) => objeto.comision === primeraComision
            );
        },
    },
    ...
    methods: {
        ...
        nombreEmpleado(idEmpleado) {
            const empleado = this.options.find(
                (emp) => emp.value == idEmpleado
            );
        ...
        async deleteEmpleado(idEmpleado, index) {
            this.$confirm(
                ``,
                `¿Desea aliminar el empleado ${this.nombreEmpleado(
                    idEmpleado
                )}?`,
                "question"
            ).then(() => {
