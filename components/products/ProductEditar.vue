              ...
              <b-overlay :show="overlay" spinner-small>
                <b-form @submit="onSubmit" @reset="onReset">
                  <b-form-group id="input-group-1" label="Producto:" label-for="input-producto">
                    <b-form-input id="input-producto" v-model="form.product" placeholder="Ingrese el producto"
                  ...
                  <b-form-group id="input-group-3" label="Precio:" label-for="input-precio">
                    <b-form-input id="input-precio" v-model="form.price" type="number" min="0" step="0.1"
                      placeholder="Ingrese la precio" required></b-form-input>
                  </b-form-group>
                  ...
                  <b-form-group id="input-group-2" label="Unidades:" label-for="input-unidades">
                    <b-form-input id="input-unidades" v-model="form.unidades" type="number" min="0" step="1"
                      placeholder="Ingrese las unidades" required></b-form-input>
                  </b-form-group>
