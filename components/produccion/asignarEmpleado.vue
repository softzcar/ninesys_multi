    ...
    methods: {
        ...
        async getCantidadExistencia() {
            await this.$axios
                ...
                .then((res) => {
                    const resultAsignacion = parseInt(
                        res.data.unidades_solicitadas
                    )
        ...
        changeCantidad() {
            ...
            if (this.departamento === "Corte") {
                if (
                    ...
                    msg =
                        msg +
                        `<li>Todas las opciones no pueden estar vacias</li>`
                } else if (
                    parseInt(this.selected) > 0 &&
                    total_a_producir === 0
                ) {
                    ban = false
                    msg =
                        msg +
                        `<li>debe indicar la cantidad de piezas a cortar</li>`
                    ...
                    solicitadas_lote > parseInt(this.loteCantidadExistencia)
                ) {
                    ban = false
                    msg =
                        msg +
            ...
            if (ban) {
                if (this.departamento != "Corte") {
                    ...
                    axios
                        ...
                        .then((res) => {
                            this.loteCantidadExistencia = parseInt(
                                res.data.piezas_actuales
                            )
