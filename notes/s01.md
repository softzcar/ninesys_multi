...
[👀️🚀️] **REPROGRAMAR VALICADION DE DISEñADORES EN TODA LA APP DE CLEITNES**
[🚀️] Programar validar la exclusión de diseños por tipo de producto virtual y no por id de categoria o id de producto
[🚀️] Poner no aplica en el select de telas en nueva orden
[ ] Banderin no tiene precio
[ ] Control de Producción no muestra insumos a empleados
[ ] Asignar porcentaje a productos
...
[ ] Activar overlay en el modal donde estan las tareas indiciduales mientras se asignan todas las tareas
