...
CREATE TABLE `salario_carga_familiar` (
  `id_carga` int(11) UNSIGNED NOT NULL COMMENT 'ID único del registro de carga familiar.',
...
ALTER TABLE `empleados_salario`
  ADD PRIMARY KEY (`id_empleado`),
  ADD KEY `idx_fecha_inicio` (`fecha_inicio_contrato`),
...
ALTER TABLE `salario_carga_familiar`
...
ALTER TABLE `salario_carga_familiar`
  MODIFY `id_carga` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID único del registro de carga familiar.';
