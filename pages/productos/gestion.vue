        ...
        >
          ...
          >
            ...
            <b-row class="mb-4">
              <b-col md="6">
                <products-new
                  :attributescat="prductAttributes"
                  :attributesval="prductAttributesValues"
                  @r="getResponseNewProduct"
                  @refresh-attributes="getProductsAttributes"
                />
              </b-col>
              <b-col md="6">
                <products-BulkLoad />
...
export default {
  ...
  methods: {
    ...
    getCategoriesWithLetters(categories) {
      ...
      return categories.filter((category) => /[a-zA-Z]/.test(category.name));
    },
    ...
    async getProductsAttributes() {
      await this.$axios
        ...
        .then((response) => {
          this.prductAttributes = response.data.data.map((item) => {
            return {
              value: item._id,
              text: item.name,
            };
