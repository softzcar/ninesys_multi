                    ...
                    >
                        <b-row>
                            <b-col>
                                ...
                                <b-list-group>
                                    <b-list-group-item
                                        >Buscar por orden y mostrar detalles del
                                        uso del insumo</b-list-group-item
                                    >
                                    <b-list-group-item
                                        >Buscar por insumo y ver que ordenes
                                        estan vinculadas al
                                        insumo</b-list-group-item
                                    >
                                    <b-list-group-item
                                        >Buscar por insumo y mostrar el
                                        rendimiento</b-list-group-item
                                    >
                                </b-list-group>
                            </b-col>
                        </b-row>
