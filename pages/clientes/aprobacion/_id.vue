        ...
        <div v-else>
          ...
          <b-row>
            <b-col>
              ...
              <b-img class="mb-4" :src="imageUrl" fluid></b-img>
            </b-col>
          </b-row>
          ...
          <b-row>
            <b-col class="text-left mt-4">
              ...
              <ul>
                <li>
                  Para comenzar a trabajar con el diseño es necesario tener
                  abonado el 50%. Una vez aprobado necesitamos el otro 50% para
                  comenzar la producción.
                </li>
                <li>
                  El tiempo de entrega puede variar entre 3 y 10 días hábiles.
                </li>
              </ul>
              ...
              <ul>
                <li>
                  No incluye diseÑo de logo, si ya tiene el logo se puede
                  incluir siempre y cuando esté en formato editable CDR, AI o
                  ESP. D lo contrario volverlo a hacer tiene un costo de 15$
                </li>
                <li>
                  Con el costo del diseÑO se incluyen 3 modificaciones, si el
                  cliente requiere modificaciónes adicionales cada modificación
                  tiene un costo adicional de 5$
                </li>
                <li>
                  NO ACEPTAMOS IMÁGENES O LOGOS REALIZADOS CON APLICACIONES DE
                  TELÉFONOS
                </li>
              </ul>
              ...
              <ul>
                <li>
                  El cliente debe proporcionar toda la información requerida
                  para su diseño referente a ideas o especificaciones concretas
                  de colores o posición de logos y elementos en el producto a
                  realizar.
                </li>
                <li>
                  Si después de aprobarse el diseñoO parte del cliente éste pide
                  una modificación tendrá un costo adicional de 5$
                </li>

                <li>
                  El tiempo de entrega desde 3 días hasta 10 días hábiles son
                  contados a partir de la fecha de aprobación del diseño.
                </li>
              </ul>
            </b-col>
          </b-row>
