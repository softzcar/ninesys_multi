                ...
                <b-container v-if="tasasCargadas">
                    <b-overlay :show="overlay" spinner-small>
                        <b-row class="mb-4">
                            <b-col>
                                <b-alert show class="mb-4" variant="warning">
                                    El cierre de caja implica el retiro del
                                    efectivo por parte de la empresa,
                                    <strong
                                        >Si va a hacer un retiro de efectivo
                                        para algun gasto, hagalo desde el
                                        siguiente link:
                                        <router-link
                                            class="nav-link"
                        ...
                        <b-row>
                            <b-col>
                                <H2
                                    >TABLA DE MONTOS EN CAJA POR TIPO DE
                                    MOENEDA</H2
                                >
                            </b-col>
                        </b-row>
            ...
            if (ok) {
                this.$confirm(
                    ...
                    .then(() => {
                        ...
                        data.set(
                            "cierreDolaresEfectivo",
                            this.form.montoDolaresEfectivo
                        )
                        data.set(
                            "cierrePesosEfectivo",
                            this.form.montoPesosEfectivo
                        )
                        data.set(
